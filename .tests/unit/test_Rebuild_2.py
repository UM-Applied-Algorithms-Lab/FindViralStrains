...
def test_Rebuild_2(conda_prefix):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        config_path = Path(".tests/unit/Rebuild_2/config")
        data_path = Path(".tests/unit/Rebuild_2/data")
        expected_path = Path(".tests/unit/Rebuild_2/expected")
        ...
        check_output(
            [
                ...
                "-m",
                "snakemake",
                "output/path_test/output_genomes/simulated/subgraph_0/simulated_1_of_2.fasta",
                "output/path_test/output_genomes/simulated/subgraph_0/simulated_2_of_2.fasta",
                "--snakefile",
