...
def test_Rebuild_1(conda_prefix):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        config_path = Path(".tests/unit/Rebuild_1/config")
        data_path = Path(".tests/unit/Rebuild_1/data")
        expected_path = Path(".tests/unit/Rebuild_1/expected")
        ...
        check_output(
            [
                ...
                "-m",
                "snakemake",
                "output/path_test/output_genomes/simulated/subgraph_0/simulated_1_of_1.fasta",
                "--snakefile",
