...
def test_Rebuild_3(conda_prefix):
    ...
    print(f"\n=== Running Rebuild_3 test (file comparison only) ===")

    # Path to your actual generated files
    generated_dir = Path("output/path_test/output_genomes/simulated/subgraph_0")
    expected_dir = Path(
        ".tests/unit/Rebuild_3/expected/output/path_test/output_genomes/simulated/subgraph_0"
    )
    ...
    # Files expected for the 3-path decomposition
    expected_files = [
        "simulated_1_of_3.fasta",
        "simulated_2_of_3.fasta",
        "simulated_3_of_3.fasta",
    ]
